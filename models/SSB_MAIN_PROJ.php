...
/**
 * This is the model class for table "SSB_MAIN_PROJ".
 *
 ...
 *
 * @property SSBPROJ[] $sSBPROJs
 */
class SSB_MAIN_PROJ extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
     ...
     */
    public function getSsbProjs()
    {
        return $this->hasMany(SSB_PROJ::className(), ['SSB_MAIN_PROJ_ID' => 'SSB_MAIN_PROJ_ID']);
    }

    public static function getNewID()
    {
        $command = Yii::$app->db->createCommand("select ssb_main_proj_id_seq.nextval as ID from dual");
