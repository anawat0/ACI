...
/**
 * This is the model class for table "NP_SAT_SURVEY_PROVINCE".
 *
 * @property  $NP_SAT_SURVEY_PROVINCE_ID
 ...
 */
class NP_SAT_SURVEY_PROVINCE extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['PROVINCE_CODE', 'YEAR', 'MONTH', 'STATUS', 'CREATE_USER_ID', 'CREATE_TIME', 'LAST_UPD_USER_ID', 'LAST_UPD_TIME'], 'required'],
    ...
    {
        return [
            'NP_SAT_SURVEY_PROVINCE_ID' => 'เลขที่อ้ำงอิง ตำรำงบันทึกผลสำรวจควำมพึงพอใจ(ศูนย์กำรเรียนรู้ฯ) ประจำอำเภอ',
    ...
    {
        $command = Yii::$app->db->createCommand("select np_sat_survey_province_id_seq.nextval as ID from dual");
