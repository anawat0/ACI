...
/**
 * This is the model class for table "IM_MAIN_PROJ".
 *
 ...
 *
 * @property IMPROJ[] $iMPROJs
 */
class IM_MAIN_PROJ extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
     ...
     */
    public function getImProjs()
    {
        return $this->hasMany(IM_PROJ::className(), ['IM_MAIN_PROJ_ID' => 'IM_MAIN_PROJ_ID']);
    }

    public static function getNewID()
    {
        $command = Yii::$app->db->createCommand("select im_main_proj_id_seq.nextval as ID from dual");
