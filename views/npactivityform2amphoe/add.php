...
$form = ActiveForm::begin([
    'id' => 'npactivityForm2AmphoeForm',
    'layout' => 'horizontal',
    'action' => Url::to(['npactivityform2amphoe/save']),
  ...
  <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">  <?php 
            		...
            		//echo $form->field($model, 'PROVINCE_CODE')->dropDownList(ArrayHelper::map(WA_PROVINCE::find()->all(), 'PROVINCE_CODE', 'PROVINCE_NAME_TH'),['onchange'=>'onChangeProvince(this)']) ; 
		            echo Utils::getDDLProvince_AutoComplete($form, $model, 'PROVINCE_CODE',
		            		'PROVINCE_CODE',
		            		'PROVINCE_NAME_TH',
		            		$province,
		            		$user_info,
		            		ArrayHelper::merge(['onchange' => 'Common.ajax.onChangeProvince(this, \'NP_ACTIVITY_FORM2_AMPHOE[AMPHOE_CODE]\', \''.$amphoe.'\')'], $optionsDDL)
		            );
		            
            	?>  </div>
            
            <div class="col-md-2" style="text-align:right;" >  <label class="control-label"><?php echo "อำเภอ" ?></label> </div>
            <div class="col-md-2">  <?php 
            		//echo $form->field($model, 'AMPHOE_CODE')->dropDownList(ArrayHelper::map(WA_AMPHOE::find()->where(['PROVINCE_CODE'=>($mode=='edit'?$model->PROVINCE_CODE:(empty($province)?'10':$province))])->all(), 'AMPHOE_CODE', 'AMPHOE_NAME_TH')) ; 
				...
				<?php
					if($mode=='edit'){
						echo Html::img(Utils::adjustImagePath($model->IMAGE_PATH), 
							...
							'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM2_AMPHOE_ID.'@@IMAGE_PATH")',
                ...
                <?php
                    ...
                    if ($mode=='edit') {
                        echo Html::img($src1, 
                            ...
                            'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM2_AMPHOE_ID.'@1@IMAGE_PATH_1")',
                            'data-toggle'=>'modal', 'data-target'=>'#modalUploadFile']);
                    } else {
                ...
                <?php
                    ...
                    if ($mode=='edit') {
                        echo Html::img($src2, 
                            ...
                            'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM2_AMPHOE_ID.'@2@IMAGE_PATH_2")',
                            'data-toggle'=>'modal', 'data-target'=>'#modalUploadFile']);
                    } else {
                ...
                <?php
                    ...
                    if ($mode=='edit') {
                        echo Html::img($src3, 
                            ...
                            'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM2_AMPHOE_ID.'@3@IMAGE_PATH_3")',
                            'data-toggle'=>'modal', 'data-target'=>'#modalUploadFile']);
                    } else {
                ...
                <?php
                    if ($mode=='edit') {
                        ...
                        echo Html::img($src4, 
                            ...
                            'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM2_AMPHOE_ID.'@4@IMAGE_PATH_4");',
                            'data-toggle'=>'modal', 'data-target'=>'#modalUploadFile']);
                    } else {
...
<div class="footcontentbutton">
    <?=$form->field($model, 'NP_ACTIVITY_FORM2_AMPHOE_ID')->hiddenInput()?>
...
<script type="text/javascript">
    ...
    jQuery('#btnUploadFile').click(function() {
    	var url = "<?= Url::to(['npactivityform2amphoe/uploadfile']); ?>";
    ...
    $(document).on('submit', '#npactivityForm2AmphoeForm', function(event) {
    ...
    function setToViewMode() {
        $form = $('#npactivityForm2AmphoeForm');
