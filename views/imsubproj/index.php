...
// 	}
	...
	$imProjId = $imProj == null? '': $imProj->IM_PROJ_ID;
?>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
			    	<?= Html::textInput('MAIN_PROJ_NAME_TH', 
			    						$imProj->imMainProj->MAIN_PROJ_NAME_TH, 
			    						['class' => 'form-control',
			    						'readonly' => 'readonly']); ?>
			    </div>
			</div>
...
<script type="text/javascript">
	var gridurl_1 = "<?= Url::to(['imsubproj/gridview', 'im_proj_id' => $imProjId]); ?>";
	var rtparams = Common.jqgrid.getDefaultPostData('<?= $rtparams; ?>', {sidx: 'IM_SUB_PROJ_ID'});
	...
	jQuery("#rowed5").jqGrid({
		...
		colNames:['ลำดับที่', 
					...
					'Actions'],
	   	colModel:[
	        {name:'id', index:'IM_SUB_PROJ_ID', width:80, align:'center', sorttype:"int", editable: true, editable: false},
			{name:'IM_PROJ_ID', index:'IM_PROJ_ID', hidden:true , editable:true, editrules:{edithidden:false}, editoptions:{defaultValue:'<?= $imProjId; ?>'}},
