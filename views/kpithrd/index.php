...
var gridurl_1 = "<?=Url::to( ['kpithrd/gridview' , 'kpidimention'=>$kpidimention , 'kpifst'=>$kpifst , 'kpisecd'=>$kpisecd] );?>";

var rtparams = Common.jqgrid.getDefaultPostData('', {sidx: 'THRD_NAME_TH'});

function gotoView1(t){
    var url='<?=Url::to(['kpifrth/'])?>';
...
jQuery("#rowed5").jqGrid({
	...
	width: jQuery('div.content').width()-20,
   	colNames:['ลำดับที่',
                ...
                'Actions'],
   	colModel:[
   		{name:'id',index:'KPI_THRD_ID', width:60, align:'center', sorttype:"int", editable: false},
   		{name:'thrdnameth',index:'THRD_NAME_TH',editable: true,editoptions:{maxlength:"255"}},   		
