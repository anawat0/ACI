...
<?php $form = ActiveForm::begin([
    'id' => 'npSatSurveyAmphoeForm',
    'method' => 'POST',
    'action' => empty($model['NP_SAT_SURVEY_AMPHOE_ID'])? Url::to(['npsatsurveyamphoe/create']): Url::to(['npsatsurveyamphoe/update']),
    'layout' => 'horizontal',
    'fieldConfig' => [
...
$model->STATUS = empty($model->npSpOpenAmphoe)? $model->STATUS: $model->npSpOpenAmphoe->STATUS;
if(empty($model->YEAR)){
	$model->YEAR = $year;
}
...
?>
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				  ...
				  <?= Html::activeLabel($model, 'PROVINCE_CODE', ['class'=>'col-sm-1 control-label']); ?>
					<div class="col-sm-3">
				        ...
				        echo Utils::getDDLProvince_AutoComplete($form, $model, 'PROVINCE_CODE',
				        		...
				        		$province,
				        		$user_info,
				        		['onchange' => 'Common.ajax.onChangeProvince(this, \'NP_SAT_SURVEY_AMPHOE[AMPHOE_CODE]\', \''.$amphoe.'\')']
				        );
						?>
				    </div>
					...
					<div class="col-sm-3">
	                    ...
	                    <div class="form-group sum"> 
	                        <?= Html::label('<p class="text-left"> <u>1. เพศ</u> </p>', null, ['class'=>'col-sm-1 control-label']); ?>				
	                    </div>
	                    
	                    <div class="form-group">
	                            <?= Html::activeLabel($model, 'NUM_MALE', ['class'=>'col-sm-2 control-label']); ?> 
				    <div class="col-sm-1">
				    ...
				    <?= Html::label('<u>รวม</u>', null, ['class'=>'col-sm-5 control-label']); ?>
				    <div class="col-sm-1">
	                    ...
	                    <div class="form-group sum"> 
	                        <?= Html::label('<p class="text-left"> <u>2. อายุ</u> </p>', null, ['class'=>'col-sm-1 control-label']); ?>				
	                    </div>
	                    
	                    
				<div class="form-group">				
					<?= Html::activeLabel($model, 'AGE_1', ['class'=>'col-sm-2 control-label']); ?>
				    <div class="col-sm-1">
				...
				<div class="form-group">
	                            <?= Html::activeLabel($model, 'AGE_5', ['class'=>'col-sm-2 control-label']); ?>
				    <div class="col-sm-1">
				        <?= $form->field($model, 'AGE_5', ['options' => ['class' => '']])
				        				->textInput(['class' => 'form-control age']); ?>
				    </div>
				    <?= Html::label('<u>รวม</u>', null, ['class'=>'col-sm-offset-6 col-sm-1 control-label']); ?>
				    <div class="col-sm-1">
	                    ...
	                    <div class="form-group sum"> 
	                        <?= Html::label('<p class="text-left"> <u>3. การศึกษา</u> </p>', null, ['class'=>'col-sm-1 control-label']); ?>				
	                    </div>
				...
				<div class="form-group">
					<?= Html::activeLabel($model, 'EDU_4', ['class'=>'col-sm-2 control-label']); ?>
				    <div class="col-sm-1">
				    ...
				    <div class="col-sm-1">
				        <?= $form->field($model, 'EDU_6', ['options' => ['class' => '']])
	                            ...
	                            <?= Html::label('<u>รวม</u>', null, ['class'=>'col-sm-1 control-label']); ?>
				    <div class="col-sm-1">
	                    ...
	                    <div class="form-group sum"> 
	                        <?= Html::label('<p class="text-left"> <u>4. สถานะภาพ</u> </p>', null, ['class'=>'col-sm-1 control-label']); ?>				
	                    </div>
				<div class="form-group">
					
	
					<?= Html::activeLabel($model, 'SINGLE', ['class'=>'col-sm-2 control-label']); ?>
				    <div class="col-sm-1">
				    ...
				    <div class="col-sm-1">
				        <?= $form->field($model, 'WIDOWED', ['options' => ['class' => '']])
	                             ...
	                             <?= Html::label('<u>รวม</u>', null, ['class'=>' col-sm-3 control-label']); ?>
				    <div class="col-sm-1">
	                    ...
	                    <div class="form-group sum"> 
	                        <?= Html::label('<p class="text-left"> <u>5. อาชีพ</u> </p>', null, ['class'=>'col-sm-1 control-label']); ?>				
	                    </div>
				...
				<div class="form-group">
				    ...
				    <div class="col-sm-1">
				        <?= $form->field($model, 'WORK_3', ['options' => ['class' => '']])
                            ...
                            <div class="form-group"> 
					<?= Html::activeLabel($model, 'WORK_4', ['class'=>'col-sm-2 control-label']); ?>
				    <div class="col-sm-1">
				...
				<div class="form-group">
					<?= Html::activeLabel($model, 'WORK_7', ['class'=>'col-sm-2 control-label']); ?>
				    <div class="col-sm-1">
...
<script type="text/javascript">
	$(function() {
        ...
        if (('<?= $isCurrentMonth ?>' == 'true')
			&& ('<?= $model["NP_SAT_SURVEY_AMPHOE_ID"]; ?>' && '<?= $model->STATUS; ?>' == 'C')) {
            setToViewMode();
        } else if (('<?= $isCurrentMonth ?>' == 'false')
			&& ('<?= $model["NP_SAT_SURVEY_AMPHOE_ID"]; ?>' && '<?= $model->STATUS; ?>' != 'S')) {
            setToViewMode();
        } else {
			$('#np_sat_survey_amphoe-province_code').change(function(e) {
				...
				.done(function(data) {
					...
					jQuery('#np_sat_survey_amphoe-amphoe_code').html(html);
				});
			});
		}
	...
	$(document).on('submit','#npSatSurveyAmphoeForm',function(event){
