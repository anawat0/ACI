...
<script type="text/javascript">
	var gridurl_1 = "<?=Url::to(['rbprojlaun/gridview']);?>";// "/browallia/web/index.php?r=rbprojlaun/gridview";
	var rtparams = Common.jqgrid.getDefaultPostData('<?=$rtparams?>', {sidx: 'RB_PROJ_LAUN_ID'});
	...
	jQuery("#rowed5").jqGrid({
		...
		width: jQuery('div.content').width()-20,
	   	...
	   	colModel:[
	   		...
	   		{name:'rb_proj_id', index:'RB_PROJ_ID', width:120, sortable:true, editable: true, edittype:'select', editoptions:{width:"200", value:<?= $listRbProj; ?>}},
	   		...
	   		{name:'proj_responsible', index:'PROJ_RESPONSIBLE', width:100, sortable:true, editable:true},
		...
		multiselect: true,
		editurl: gridurl_1,
		caption: 'RD002 แผนงาน-โครงการ ที่กำลังดำเนินการ',
	   	rowNum: 10,
	   	rowList: [10,20,30],
	   	pager: '#pagered',
	    viewrecords: true,
