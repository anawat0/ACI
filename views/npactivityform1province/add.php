...
$form = ActiveForm::begin([
    'id' => 'npactivityForm1ProvinceForm',
    'layout' => 'horizontal',
    'action' => Url::to(['npactivityform1province/save']),
...
<div class="panel panel-primary">        
  ...
  <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-md-1" style="text-align:right;" >  <label style="padding-top:8px;"><?php echo $model->getAttributeLabel('MONTH'); ?></label> </div>
 			<div class="col-sm-2"><?= $form->field($model, 'MONTH', ['options' => ['class' => '']])
			        				->dropDownList(Utils::getArrMonth(),
													$optionsDDL); ?>
			</div> 

            <div class="col-md-1" style="text-align:right;" >  <label style="padding-top:8px;"><?php echo "จังหวัด" ?></label> </div>
            <div class="col-md-2">  <?php 
            	//echo $form->field($model, 'PROVINCE_CODE')->dropDownList(ArrayHelper::map(WA_PROVINCE::find()->all(), 'PROVINCE_CODE', 'PROVINCE_NAME_TH')) ; 
		...
		<div class="form-group">
            ...
            <div class="col-md-2">  <?php echo $form->field($model, 'SUBJECT_RESULT')->textInput() ; ?>  </div>
				...
				<?php
					if($mode=='edit'){
						echo Html::img(Utils::adjustImagePath($model->IMAGE_PATH), 
							...
							'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM1_PROVINCE_ID.'@@IMAGE_PATH")',
                ...
                <?php
                    ...
                    if ($mode=='edit') {
                        echo Html::img($src1, 
                            ...
                            'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM1_PROVINCE_ID.'@1@IMAGE_PATH_1")',
                            'data-toggle'=>'modal', 'data-target'=>'#modalUploadFile']);
                    } else {
                ...
                <?php
                    ...
                    if ($mode=='edit') {
                        echo Html::img($src2, 
                            ...
                            'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM1_PROVINCE_ID.'@2@IMAGE_PATH_2")',
                            'data-toggle'=>'modal', 'data-target'=>'#modalUploadFile']);
                    } else {
                ...
                <?php
                    ...
                    if ($mode=='edit') {
                        echo Html::img($src3, 
                            ...
                            'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM1_PROVINCE_ID.'@3@IMAGE_PATH_3")',
                            'data-toggle'=>'modal', 'data-target'=>'#modalUploadFile']);
                    } else {
                ...
                <?php
                    if ($mode=='edit') {
                        ...
                        echo Html::img($src4, 
                            ...
                            'onclick'=>'Common.bootstrap.modal.displayImg(this, "'.$model->NP_ACTIVITY_FORM1_PROVINCE_ID.'@4@IMAGE_PATH_4");',
                            'data-toggle'=>'modal', 'data-target'=>'#modalUploadFile']);
                    } else {
...
<div class="footcontentbutton">
    <?=$form->field($model, 'NP_ACTIVITY_FORM1_PROVINCE_ID')->hiddenInput()?>
...
<script type="text/javascript">
    function onClickSave(){
        ...
        jQuery.post('<?=Url::to(['npactivityform1province/save']);?>', data, function(data){
            //on ajax success.
            alert('Success');
    ...
    function setToViewMode() {
        $form = $('#npactivityForm1ProvinceForm');
    ...
    jQuery('#btnUploadFile').click(function() {
    	var url = "<?= Url::to(['npactivityform1province/uploadfile']); ?>";
        ...
        var year = jQuery('[name="NP_ACTIVITY_FORM1_PROVINCE[YEAR]"]').val();
        ...
        Common.ajax.ajaxFileUploadCustomParams(
        {
            ...
            onSuccess: function(data, staus) {
                if (data.success) {
                    ...
                    BootstrapDialog.alert('เกิดข้อผิดพลาด กรุณาติดต่อผู้ดูแลระบบ');
                }
            }
        });
    });

    $(document).on('submit', '#npactivityForm1ProvinceForm', function(event) {
